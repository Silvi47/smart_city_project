...
from models.index import vehicles
from schemas.vehicles import VehicleSchema, Vehicleslimit
...
@vehicle.get("/vehicles/category/time", name="Filter by Time",
             description="Counting Data by Time")
...
@vehicle.get("/vehicles/category/type", name="Filter by Type",
             description="Counting Data by Vehicle Type")
...
@vehicle.get("/vehicles/category/city", name="Filter by Plate City",
             description="Counting Data by Plate City")
...
@vehicle.get("/vehicles/category/time-type", name="Filter by Time and Type",
             description="Counting Data by Time and Type")
...
@vehicle.get("/vehicles/category/time-city", name="Filter by Time and Plate City",
             description="Counting Data by Time and PlateCity")
...
@vehicle.get("/vehicles/category/city-type", name="Filter by Plate City and Type",
             description="Counting Data by Plate City and Type")
...
@vehicle.get("/vehicles/category/time-type-city", name="Filter by Time, Type, and Plate City",
             description="Counting Data By Time, Type, and Plate City")
...
@vehicle.get("/vehicles/all", response_model=Vehicleslimit, 
...
@vehicle.get("/vehicles/{id}", name="Read Vehicle By ID", description="Show the detail of each data")
